/*
 *
 *	Copyright (c) 2014 Thomas Mayo-Smith
 *	www.github/generalmayo
 *
...
//curiosity and speed behavior constants
var sC = 5000; //speed factor constant
...
function init(){
	sC = document.getElementById("speedScaleVal").value;
	console.log("sC: "+sC);
...
function getCuriosityFactor(car){
	...
	*/
	...
	var sf = ((MAX_SPEED - car.dx)/MAX_SPEED)*(1/sC)
...
//updates the positions of each car being displayed
function update(){
	i=0
	while(i<cars.length){
		car = cars[i]
